...
HEADER_LENGTH_Y = HEADER_PITCH + XY_TOLERANCE;
HEADER_LENGTH_Z = HEADER_PITCH + Z_TOLERANCE;
...
EDGE_BOLTS_DISTANCE = 30;
EDGE_CONNECTOR_THICKNESS = 3;
EDGE_CONNECTOR_LENGTH = 10;
