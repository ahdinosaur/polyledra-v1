...
CHANNEL_LENGTH_HYP = sqrt(2 * pow(CHANNEL_LENGTH_XY, 2));
CHANNEL_BULGE_OFFSET = triangle_height(CHANNEL_LENGTH_HYP, CHANNEL_LENGTH_XY, CHANNEL_LENGTH_XY);
CHANNEL_BULGE_RX = CHANNEL_BULGE_OFFSET / 2;
CHANNEL_BULGE_RY = CHANNEL_LENGTH_HYP / 2;
...
HEADERS_RADIUS = CHANNEL_LENGTH_XY / 2 + CHANNELS_RADIUS + 0.7;

EDGE_CONNECTOR_SIDES = CHANNELS_PER_EDGE * 2;
EDGE_CONNECTOR_RADIUS = CHANNEL_LENGTH_XY + CHANNELS_RADIUS + 3;
...
module main () {
  echo(
    inner_bolt_radius=INNER_BOLTS_RADIUS,
