...
CHANNELS_PER_EDGE = 3;
CHANNEL_DEPTH = 8;
CHANNEL_LENGTH = 16 + XY_TOLERANCE;
CHANNEL_RADIUS = 2;

HEADER_DEPTH = 2.54;
HEADER_PITCH = 2.54;
HEADER_NUM_PINS = 4;
HEADER_LENGTH = HEADER_PITCH * HEADER_NUM_PINS + XY_TOLERANCE;
HEADER_WIDTH = 2.54 + XY_TOLERANCE;
...
BOLT_SIZE = 4;
BOLT_LENGTH = EDGE_CONNECTOR_HEIGHT - 2;
